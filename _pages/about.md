...
<!-- 🚨 REMINDER: Add your real photo! Replace the avatar in _config.yml with a professional headshot -->
<!-- Save as: /assets/img/jonathan-shulgach-photo.jpg -->
...
<div style="margin: 1.5em 0;">
  <a href="/assets/docs/Jonathan-Shulgach-CV.pdf" class="btn btn--primary btn--large" download><i class="fas fa-file-pdf"></i> Download CV</a>
</div>
...
<div style="text-align: center; margin-top: 2em;">
  <a href="/contact/" class="btn btn--primary btn--large"><i class="fas fa-envelope"></i> Contact Me</a>
  <a href="/publications/" class="btn btn--info btn--large"><i class="fas fa-book"></i> View Publications</a>
</div>
...
![Jonathan with a sloth](/assets/img/me-sloth.jpg){: .align-center style="max-width: 400px; border-radius: 10px;"}
